...
ENTRYPOINT echo `pwd`; java -Dlog4j2.formatMsgNoLookups=true -jar ./backoffice_server-0.0.1-SNAPSHOT.jar --spring.config.location="/backoffice_server/config/application.properties","/backoffice_server/config/kakaobizmessage.yml"
