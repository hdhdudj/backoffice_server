...
@Getter
@Setter
public class ShipEtcItemListResponseData {
	public ShipEtcItemListResponseData(LocalDate startDt, LocalDate endDt, String assortId, String assortNm,
	...
	public static class Item {
		public Item(Lsdpsd lsdpsd) {
			...
			this.shipDt = Utilities.removeTAndTransToStr(lsdpsd.getLsdpsm().getDepositDt());
